...
**CI:** [`.github/workflows/ci.yml`](../.github/workflows/ci.yml) (fmt, clippy, test, release build on Ubuntu). Releases: [`release.yml`](../.github/workflows/release.yml) (push tag `v*` for a GitHub Release; **manual dispatch** for test builds—archive label + optional “create GitHub Release”). Nightly binaries: [`nightly.yml`](../.github/workflows/nightly.yml) (daily UTC schedule + manual dispatch; builds default branch).
