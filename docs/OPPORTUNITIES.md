...
| [OPP-024](opportunities/OPP-024-sqlite-js-wasm-driver.md) | SQLite — WASM / JS-Only Driver for Installability | Optional move off `better-sqlite3` native addon to reduce Node ABI / compile friction; spike FTS5 + persistence; trade CPU/memory for portable installs. Latency vs LLM/IMAP is secondary. |
